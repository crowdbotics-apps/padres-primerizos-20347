"""padres_primerizos_20347 URL Configuration
...
admin.site.site_header = "padres primerizos"
admin.site.site_title = "padres primerizos Admin Portal"
admin.site.index_title = "padres primerizos Admin"

# swagger
api_info = openapi.Info(
    title="padres primerizos API",
    default_version="v1",
    description="API documentation for padres primerizos App",
)
